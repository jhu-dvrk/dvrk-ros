function [config_lse_joint1, config_lse_joint2_3,config_lse_joint4,config_lse_joint5,config_lse_joint6]=...
...
%  Created on: 2018-10-05
    ...
    symbolic_file = config.lse.symbolic_file;
    ...
    Joint_No = 6;
    config_lse_joint6 =  config_lse(Joint_No,std_filter,symbolic_file,Is_Plot,...
                  issave_figure,[input_path,'/Train_Joint6'],config.lse.joint6.fit_method,g_constant);

    Joint_No = 5;
    config_lse_joint5 =  config_lse(Joint_No,std_filter,symbolic_file,Is_Plot,...
                  issave_figure,[input_path,'/Train_Joint5'],config.lse.joint5.fit_method,g_constant);


    Joint_No = 4;
    config_lse_joint4 =  config_lse(Joint_No,std_filter,symbolic_file,Is_Plot,...
                  issave_figure,[input_path,'/Train_Joint4'],config.lse.joint4.fit_method,g_constant);


    Joint_No = 3;
    config_lse_joint2_3 =  config_lse(Joint_No,std_filter,symbolic_file,Is_Plot,...
                  issave_figure,[input_path,'/Train_Joint3'],config.lse.joint2_3.fit_method,g_constant);
    config_lse_joint2_3 = config_lse_joint2_3.set_prior();


    Joint_No = 1;
    config_lse_joint1 =  config_lse(Joint_No,std_filter,symbolic_file,Is_Plot,...
