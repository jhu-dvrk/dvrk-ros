...
def dictionary(robotName):
    ...
    dict['i'] = [('r',0,40),('r',180,20),('r',90,60),('r',180,20),('r',0,40)]
    dict['j'] = [('u'),('r',90,16),('d'),('r',306.86,15),('r',0,12),('r',36.86,15),('r',90,40),('r',180,12),('r',0,24)]
    ...
    dict['r'] = [('r',90,60),('r',0,40),('r',270,30),('r',180,40),('r',305,40)]
    ...
    while letter_number < .2:  
        ...
        letter_number +=.05
        r.delta_move_cartesian([0.0,0.0,0.01])
        r.move_cartesian_translation([start_x+letter_number,0.0,-0.12])
        r.delta_move_cartesian([0.0,0.0,-0.01])
