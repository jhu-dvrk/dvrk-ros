...
def dictionary(robotName):
    ...
    dict['c'] = [('r',0,35),('d'),('r',180,30),('r',108.43,15.8114),('r',90,30),('r',71.57,15.8114),('r',0,30),('r',180,30),('r',251.57,15.8114),('r',270,30),('r',288.43,15.8114),('r',0,30)]
    dict['d'] = [('d'),('r',90,60),('r',340,30),('r',270,40),('r',200,30)]
    dict['e'] = [('r',0,40),('d'),('r',180,40),('r',90,30),('r',0,30),('r',180,30),('r',90,30),('r',0,40),('r',180,40),('r',270,60),('r',0,40)]
    dict['f'] = [('d'),('r',90,30),('r',0,30),('r',180,30),('r',90,30),('r',0,40),('r',180,40),('r',270,60)]
    dict['g'] = [('r',0,40),('r',90,35),('r',180,12),('d'),('r',0,12),('r',270,35),('r',180,40),('r',90,60),('r',0,40),('r',180,40),('r',270,60),('r',0,40)]
    dict['h'] = [('d'),('r',90,60),('r',270,30),('r',0,40),('r',90,30),('r',270,60)]
    dict['i'] = [('d'),('r',0,40),('r',180,20),('r',90,60),('r',180,20),('r',0,40),('r',180,20),('r',270,60),('r',0,20)]
    dict['j'] = [('r',90,16),('d'),('r',306.86,15),('r',0,12),('r',36.86,15),('r',90,40),('r',180,12),('r',0,24),('r',180,12),('r',270,40)]
    ...
    dict['n'] = [('d'),('r',90,60),('r',303.69,72),('r',90,60),('r',270,60)]
    dict['o'] = [('d'),('r',0,40),('r',180,40),('r',90,60),('r',0,40),('r',270,60)]
    dict['p'] = [('d'),('r',90,60),('r',0,40),('r',270,30),('r',180,40),('r',270,30)]
    dict['q'] = [('d'),('r',90,60),('r',0,40),('r',270,60),('r',180,40),('r',0,40),('r',135,12),('r',315,24)]
    dict['r'] = [('d'),('r',90,60),('r',0,40),('r',270,30),('r',180,40),('r',315,45)]
    dict['s'] = [('d'),('r',0,40),('r',90,30),('r',180,40),('r',90,30),('r',0,40),('r',180,40),('r',270,30),('r',0,40),('r',270,30)]
    dict['t'] = [('r',0,20),('d'),('r',90,60),('r',180,20),('r',0,40),('r',180,20),('r',270,60)]
    dict['u'] = [('d'),('r',90,60),('r',270,60),('r',0,40),('r',90,60),('r',270,60)]
    dict['v'] = [('r',0,20),('d'),('r',108.44,63),('r',288.44,63),('r',71.56,63),('r',251.56,63)]
    dict['w'] = [('d'),('r',90,60),('r',270,60),('r',0,20),('r',90,40),('r',270,40),('r',0,20),('r',90,60),('r',270,60)]
    dict['x'] = [('d'),('r',56.31,72),('r',236.31,36),('r',123.69,36),('r',303.69,72)]
    dict['y'] = [('r',0,20),('d'),('r',90,30),('r',56.31,36),('r',236.31,36),('r',123.69,36),('r',303.69,36),('r',270,30)]
    dict['z'] = [('d'),('r',56.31,72),('r',180,40),('r',0,40),('r',236.31,72),('r',0,40)]
