"""In this example we will take a look at the how our robot will move in terms of cartesian position. Through this example we will be running this code in parallel to another program. Through this program we can see the difference between 
the desired path and the current path. For this example we are using Matplotlib. More information on the software can be found here at http://matplotlib.org. Lets take a look:"""
